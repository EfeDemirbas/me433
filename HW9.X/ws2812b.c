...
void ws2812b_setup() {
    ...
    // TRIS...
    TRISAbits.TRISA3 = 0; //Make RA3 output for bit-banging
    // LAT...
    LATAbits.LATA3 = 0;
}
...
void ws2812b_setColor(wsColor * c, int numLEDs) {
    ...
    volatile int nB = 1; // which high/low bit you are storing, 2 per color bit, 24 color bits per WS2812B
...
wsColor HSBtoRGB(float hue, float sat, float brightness) {
    volatile float red = 0.0;
    volatile float green = 0.0;
    volatile float blue = 0.0;
